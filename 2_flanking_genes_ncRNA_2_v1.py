...
## working to reorganize this script so its more functional, and easier to read
#work on quality control

### TODO (notes to myself)(come back to this)
...
### STARTING MATERIALS:
#parsed down gff3 file. gff3 file from flybase (in "flybase" folder). Parse script, called "1_parse_gff3.py", using output from script called "1_dmel_genes_ncRNA_2016-06-07_out.txt"
